 ...
 */
public class PSRecyclerViewPager extends RecyclerViewPager implements PSComponent {
    private boolean immediatelyUpdating;
    private boolean initializedSubviews;
    private boolean scrollable = true;

    public PSRecyclerViewPager(Context context) {
        super(context);

        initProperties(context, null, 0, 0);
    }

    public PSRecyclerViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);

        initProperties(context, attrs, 0, 0);
    }

    public PSRecyclerViewPager(Context context, AttributeSet attrs, int defStyleAttr) {
